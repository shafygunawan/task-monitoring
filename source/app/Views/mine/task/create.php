...
<!-- Outer Row -->
<form method="POST" action="/offices/<?= $office['officeIdentifier']; ?>/create-task">
    <?= csrf_field() ?>
    <div class="form-group row">
        <label for="inputEmail3" class="col-sm-2 col-form-label">Judul Tugas</label>
        <div class="col-sm-10">
            <input type="text" class="form-control <?= $validation->hasError('title') ? 'is-invalid' : ''; ?>" id="inputEmail3" name="title" value="<?= old('title'); ?>">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="datetime-local" class="form-control <?= $validation->hasError('deadlines') ? 'is-invalid' : ''; ?>" id="inputEmail3" name="deadlines" value="<?= old('deadlines'); ?>">
            <div class="invalid-feedback">
